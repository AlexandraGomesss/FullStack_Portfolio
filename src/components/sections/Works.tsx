  ...
  return (
    <motion.div variants={fadeIn('up', 'spring', index * 0.5, 0.75)}>
      <Tilt glareEnable tiltEnable tiltMaxAngleX={30} tiltMaxAngleY={30} glareColor="#aaa6c3">
        <div className="bg-tertiary h-[550px] w-full rounded-2xl p-5 lg:w-[350px] sm:w-[300px]">
...
const Works = () => {
  return (
    <>
      ...
      <div className="mt-20 w-full max-w-7xl mx-auto flex flex-wrap justify-center gap-7">
